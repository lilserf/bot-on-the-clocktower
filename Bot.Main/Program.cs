    ...
    public class Program
    {
        static async Task Main(string[] _)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .Destructure.ByIgnoringProperties<DSharpChannel>(x => x.Wrapped, x => x.Users, x => x.Channels)
                ...
                .Destructure.ByTransforming<Game>(x => new { Town = x.Town, Storytellers = x.Storytellers })
                .MinimumLevel.Debug()
                .WriteTo.Console()
